...
//   // Render child component safely with fallback props if needed
//   const renderComponent = () => {
//     if (!user) return <p>Loading user data...</p>; // Show loading until user is ready

//     switch (componentName) {
//       case "My Profile":      return <MyProfile user={user} />;
//       case "Update Profile":  return <UpdateProfile user={user} />;
//       case "Update Password": return <UpdatePassword user={user} />;
//       case "Job Post":        return <JobPost user={user} />;
//       case "My Jobs":         return <MyJobs user={user} />;
//       case "Applications":    return <Applications user={user} />;
//       case "My Applications": return <MyApplications user={user} />;
